...
<tileset version="1.10" tiledversion="1.11.2" name="Blue Dolphin" tilewidth="16" tileheight="16" tilecount="32" columns="16">
 <image source="Blue Dolphin.png" width="256" height="32"/>
 <tile id="0">
  <animation>
